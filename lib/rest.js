...
async function getLaptops(){
    ...
    config.data = params;
    config.method = "get";
    config.url = "http://127.0.0.1:8036/CMPS4191_adv_web_RESTAPI/laptops";
...
async function getCustomers(){
    ...
    config.data = params;
    config.method = "get";
    config.url = "http://127.0.0.1:8036/CMPS4191_adv_web_RESTAPI/users/customers";
...
async function getUsers(){
    ...
    config.data = params;
    config.method = "get";
    config.url = "http://127.0.0.1:8036/CMPS4191_adv_web_RESTAPI/users";
...
async function getEmployees(){
    ...
    config.data = params;
    config.method = "get";
    config.url = "http://127.0.0.1:8036/CMPS4191_adv_web_RESTAPI/users/employees";
